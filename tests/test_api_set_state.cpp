...
TEST_CASE("ApiSetState", "[api][debug][set_state]"){
    ...
    SECTION("success"){
        ...
        new_state.terrain = {gm::Obstacle{1,1,gm::Obstacle::Type::Wall}, gm::Obstacle{2,2,gm::Obstacle::Type::Wall}};
        new_state.players[0].posX += 2;
        new_state.players[0].posY += 2;
        new_state.players[1].posX += 2;
        new_state.players[1].posY += 2;
