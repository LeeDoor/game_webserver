...
namespace game_manager{
    ...
    bool QueueManagerRedis::EnqueuePlayer(const um::Uuid& uuid) {
    ...
    bool QueueManagerRedis::DequeuePlayer(const um::Uuid& uuid) {
    ...
    std::vector<um::Uuid> QueueManagerRedis::GetQueue(int start, int end) {
